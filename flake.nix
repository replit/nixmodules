{
  ...
  inputs.nixpkgs-legacy.url = "github:nixos/nixpkgs/nixos-21.11";
  ...
  outputs = { self, nixpkgs, nixpkgs-legacy, nixpkgs-unstable, prybar, java-language-server, ... }:
    let
      ...
      pkgs-legacy = mkPkgs nixpkgs-legacy "x86_64-linux";
